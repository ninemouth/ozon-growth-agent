...
const acceptanceMatrix = [
  {
    id: "RB-01",
    area: "Ozon 店铺体检",
    startPage: "Ozon seller/store page",
    trigger: "右侧悬浮栏：店铺体检",
    requiredEvidence: [
      "平台属性、店铺定位、调性/格调读取",
      "Ozon 搜索/榜单证据",
  ...
  },
  {
    ...
    startPage: "Ozon seller/store page or Ozon category/search page",
    trigger: "右侧悬浮栏：平台趋势",
    requiredEvidence: [
  ...
  },
  {
    id: "RB-03",
    area: "Ozon 商品诊断 / 评论采集",
    startPage: "Ozon product detail page",
    trigger: "右侧悬浮栏：商品分析/评论分析",
    requiredEvidence: [
  ...
  },
  {
    id: "RB-04",
    area: "供应商货源 / 1688 图搜",
    startPage: "Ozon product page with target image",
    trigger: "右侧悬浮栏：供应商货源",
    requiredEvidence: [
      "以图搜图进入 1688 结果页",
  ...
  },
  {
    ...
    area: "供应商货源 / 淘宝兜底",
    startPage: "Ozon product page with target image",
    trigger: "右侧悬浮栏：供应商货源，1688 受阻后兜底",
    requiredEvidence: [
      "淘宝/天猫结果页 DOM 与截图证据",
...
assert.ok(acceptanceMatrix.some((item) => item.requiredEvidence.join(" ").includes("candidateTexts")), "sourcing acceptance must cover semantic filter candidates");
