...
2. **多层次竞争与流量证据链来源**：
   ...
   - **Yandex 搜索站外对标 (Yandex Search)**：对于俄罗斯本地互联网大盘需求及站外引流，可以使用 Yandex 普通搜索结果页诊断商品自然搜索词的排序能见度、站外内容入口和竞品分布。报告中统一写成“Yandex 搜索”，不要把普通搜索入口误写成 Yandex Wordstat、Yandex Market，或把 `Yandex.ru` 当作 `Yandex.com` 搜索引擎的同义标签。
